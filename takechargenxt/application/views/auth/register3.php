                    ...
                    <div class="kt-login__container">
                        ...
                        <div class="kt-login__signin">
                            <div class="kt-login__head">
                                <h3 class="kt-login__title">Mobile Phone Verificaton</h3>
                                <div class="kt-login__desc">Enter your code to verify your phone number:</div>
                            </div>
                            <?php echo (isset($code_error))?$code_error:""; ?>
                            <?php echo form_open('user/signup3_post','class="kt-login__form kt-form"'); ?>
                                <input type="hidden" name="randomid" value="<?php echo (isset($randomid))?$randomid:''; ?>" >
                                <div class="input-group">
                                    <input class="form-control" type="text" placeholder="Enter Code" name="phone_code" id="phone_code" autocomplete="off">
                                </div>
