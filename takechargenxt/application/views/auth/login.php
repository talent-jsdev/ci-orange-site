				...
				<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
					<div class="kt-login__container">
							...
							<form class="kt-form" action="">
								...
								<div class="row kt-login__extra">
									...
									<div class="col kt-align-right">
										<a href="<?php echo base_url()?>user/forgetpassword" id="kt_login_forgot" class="kt-link kt-login__link">Forget Password ?</a>
									</div>
								</div>
								<div class="kt-login__actions">
									<a href="<?php echo site_url() ?>home" style="height:auto;padding-top:13px;padding-bottom:12px;" id="kt_login_signin_submit" class="btn btn-pill kt-login__btn-primary">Sign In</a>
								</div>
							</form>
						</div>
						<div class="kt-login__account">
							...
							<a href="<?php echo base_url()?>user/signup" id="kt_login_signup" class="kt-link kt-link--light kt-login__account-link">Sign Up</a>
						</div>
					</div>
				</div>
			</div>
